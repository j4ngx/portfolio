    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <FadeInSection>
        <div className="max-w-2xl mx-auto px-4 relative z-10">
          ...
          {status === 'sent' ? (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-8 text-center" role="status" aria-live="polite">
              <Icon icon="check_circle" className="text-green-600 dark:text-green-400 text-4xl mb-3 block" />
